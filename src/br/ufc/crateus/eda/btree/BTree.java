...
public class BTree<K extends Comparable<K>, V> {
	...
	public void insert(K key, V value) throws Exception {
		...
		if (root.isOverflowed()) {
			...
			Page<K> left = pageSerializer.createPage(root.asSymbolTable(), root.isExternal());
			left.close();
	...
	private void insert(Page<K> r, K key, V value) throws Exception {
	...
	public static void main(String[] args) throws Exception {
        ...
        System.out.println(st.get("www.cnn.com"));
	}
